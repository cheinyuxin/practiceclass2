...
2.2 由於原始資料的時區為UTC，請透過`lubridate::with_tz()`將時區設為。

```{r ans22}
lubridate::with_tz(seq(ymd("2017-12-28 10:28:58"), ymd("2017-12-28 18:28:58"), by = "hour"))
```
...
```{r ans23}
library(stringr)
str_split_fixed(filmVotingData$hour,n=1,simply=true)->splitResult
